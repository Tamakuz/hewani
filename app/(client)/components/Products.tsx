...
const ProductsSection = () => {
  return (
    <section
      id="products"
      className="bg-gradient-to-b from-emerald-50 to-emerald-100 py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-base sm:text-lg md:text-xl text-emerald-700 text-center max-w-3xl mx-auto mb-10 sm:mb-12 md:mb-16 lg:mb-20 leading-relaxed">
          Temukan pilihan hewan ternak terbaik untuk kebutuhan Anda. Dari
          kambing etawa hingga sapi limosin, kami menyediakan hewan berkualitas
          tinggi untuk qurban, aqiqah, atau peternakan Anda.
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-8 md:gap-10">
          {products.map((product) => (
            <div
              key={product.id}
              className="bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 flex flex-col"
            >
              ...
              <div className="p-4 sm:p-5 md:p-6 flex-grow flex flex-col">
                ...
                <p className="text-sm sm:text-base text-emerald-600 mb-3 sm:mb-4 line-clamp-2 flex-grow">
                  {product.description}
                </p>
